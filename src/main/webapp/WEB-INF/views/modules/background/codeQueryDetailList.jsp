...
<ul class="nav nav-tabs">
	<li class="active"><a href="${ctx}/background/manage/codeQueryDetailList">防伪码查询情况报表（明细）</a></li>
</ul>
<form:form id="searchForm" modelAttribute="codeQueryInfo" action="${ctx}/background/manage/codeQueryDetailList" method="post" class="breadcrumb form-search">
