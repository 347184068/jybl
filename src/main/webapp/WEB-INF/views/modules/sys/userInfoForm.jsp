...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/userInfo/">用户信息列表</a></li>
		<li class="active"><a href="${ctx}/sys/userInfo/form?id=${userInfo.id}">用户信息<shiro:hasPermission name="sys:userInfo:edit">${not empty userInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:userInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userInfo" action="${ctx}/sys/userInfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="personName" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
