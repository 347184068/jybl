...
<head>
	...
	<style type="text/css">
		...
		#header .brand {font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:24px;padding: 0px; height: 50px;}
		#footer {margin:8px 0 0 0;padding:3px 0 0 0;font-size:11px;text-align:center;border-top:2px solid #0663A2;}
		#footer, #footer a {color:#999;} #left{overflow-x:hidden;overflow-y:auto;} #left .collapse{position:static;}
		#userControl>li>a{/*color:#fff;*/text-shadow:none;} #userControl>li>a:hover, #user #userControl>li.open>a{background:transparent;}
		#header .brand .wc-logo{
			height: 40px;
			float: left;
			margin-left: 20px;
			margin-top: 5px;
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand">
					<img src="${ctxStatic}/img/wc-logo.png" class="wc-logo">
					<span id="productName">
					${fns:getConfig('productName')}</span></div>
