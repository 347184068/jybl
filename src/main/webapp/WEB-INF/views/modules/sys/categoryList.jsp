...
<body>
	...
	<table id="treeTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="sys:category:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			<td><a href="${ctx}/sys/category/form?id={{row.id}}">
				{{row.name}}
			</a></td>
			<td>
				{{row.updateDate}}
			...
			<shiro:hasPermission name="sys:category:edit"><td>
   				<a href="${ctx}/sys/category/form?id={{row.id}}">修改</a>
				<a href="${ctx}/sys/category/delete?id={{row.id}}" onclick="return confirmx('确认要删除该分类及所有子分类吗？', this.href)">删除</a>
				<a href="${ctx}/sys/category/form?parent.id={{row.id}}">添加下级分类</a> 
