...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/weixin/wxMenu?menuType=2">微信菜单列表</a></li>
		<li class="active"><a href="${ctx}/weixin/wxMenu/form?menuType=2&id=${wxMenu.id}&parent.id=${wxMenuparent.id}">微信菜单<shiro:hasPermission name="weixin:wxMenu:edit">${not empty wxMenu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="weixin:wxMenu:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
