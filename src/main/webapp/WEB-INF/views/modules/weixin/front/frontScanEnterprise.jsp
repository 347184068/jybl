...
<title>潍柴动力产品追踪微信助手</title>
	...
	<script type="text/javascript">
		...
		function getScanInfo(resultStr){
			var url = "<%=request.getContextPath()%>/validateEnterprise/scanQrCode/validateCode";
			...
			$.ajax({
				...
				success : function(result) {
					...
					if(result.flag){
						...
						var orderInfo = '<li class="mui-table-view-cell"><span style="font-weight: bold;">订单信息</span>：</li>'+
								'<li class="mui-table-view-cell" id="purchaseOrder">'+
								'订单号：'+result.purchaseOrder+'</li>'+

								'<li class="mui-table-view-cell" id="shippingOrder">发运单号：'+
								result.shippingOrder+'</li>'+
								'<li class="mui-table-view-cell" id="materialName">发运时间：'+
								result.shippingTime+'</li>';

						$("#list_content").append(orderInfo);

						var supplierInfo ='<li class="mui-table-view-cell"><span style="font-weight: bold;">经销商信息</span>：</li>'+
								'<li class="mui-table-view-cell" id="SupplierName">'+
								'经销商名称：'+result.supplierName+'</li>';

						$("#list_content").append(supplierInfo);
