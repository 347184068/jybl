...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/weixin/wxMenu?menuType=2">微信菜单列表</a></li>
		<shiro:hasPermission name="weixin:wxMenu:edit">
			<li><a href="${ctx}/weixin/wxMenu/form?menuType=2">微信菜单添加</a>
	...
	<script  type="text/javascript">
		$(function () {
			$("#syn").bind("click",function(){
				...
				$.jBox.tip("1");
				$.get("${ctx}/weixin/wxMenu/syncCrop?menuType=2",function(data){
					if("1"==data){
