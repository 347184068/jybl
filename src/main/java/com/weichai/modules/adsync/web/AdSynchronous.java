package com.weichai.modules.adsync.web;

import com.google.common.collect.Lists;
import com.weichai.common.utils.ResData;
import com.weichai.common.utils.StringUtils;
import com.weichai.common.web.BaseController;
import com.weichai.modules.adsync.config.AdConfig;
import com.weichai.modules.adsync.service.AdUpdateService;
import com.weichai.modules.sys.dao.OfficeDao;
import com.weichai.modules.sys.entity.Area;
...
import com.weichai.modules.sys.service.AreaService;
import com.weichai.modules.sys.service.OfficeService;
import com.weichai.modules.sys.service.SystemService;
            ...
            if (updDateTime.equals("") || BigDecimal.valueOf(Long.valueOf(whenChange.substring(0, 14)))
                ...
                if(StringUtils.isNotBlank(adId)) {
                    ...
                    if(wcUserMap.containsKey(countName)) {
                        ...
                        user.setEmail(account+"@weichai.com");
                        user.setRemarks("AD");
